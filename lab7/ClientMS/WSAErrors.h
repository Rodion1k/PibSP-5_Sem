...
inline string get_error_message(int code)
{
    string msgText;
    switch (code)
    {
    ...
    case WSAEINVAL: msgText = "Ошибка в аргументе";
        break;
    case WSAEMFILE: msgText = "Открыто слишком много файлов";
        break;
    ...
    case WSAECONNABORTED: msgText = "Программный отказ связи";
        break;
    case WSAECONNRESET: msgText = "Связь не восстановлена";
        break;
    ...
    case WSASYSCALLFAILURE: msgText = "Аварийное завершение системного вызова";
        break;
    case 2: msgText = "Неудачное завершение";
        break;
    case ERROR_NO_DATA: msgText = "The pipe is being closed";
        break;
    case ERROR_PIPE_CONNECTED: msgText = "There is a process on other end of the pipe";
        break;
    case ERROR_PIPE_LISTENING: msgText = "Waiting for a process to open the other end of the pipe";
        break;
    case ERROR_CALL_NOT_IMPLEMENTED: msgText = "This function is not supported on this system";
        break;
    case ERROR_INVALID_NAME: msgText = "The filename, directory name, or volume label syntax is incorrect.";
        break;
    case ERROR_SEM_TIMEOUT: msgText = "The semaphore timeout period has expired.";
        break;
...
inline string set_error_msg(string msgText, int code)
{
    return msgText + get_error_message(code) + "\n\n";
}
